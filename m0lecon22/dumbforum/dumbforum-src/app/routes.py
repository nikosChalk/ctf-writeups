...
def profile():
    ...
    # Some debug code to make exploitation easier    
    # username = request.args.get('username')
    # email = request.args.get('email')
    # about_me = request.args.get('about_me')
    # profile_html = profile_html % (username, email, about_me)    # UNSAFE

    # original vulnerability
    profile_html = profile_html % (current_user.username, current_user.email, current_user.about_me)    # UNSAFE

    if(current_user.about_me == None):
        current_user.about_me = ""

    # some more debug code to help exploitation
    LOGGER.info('current_user.username: ' + current_user.username)
    LOGGER.info('current_user.email: ' + current_user.email)
    LOGGER.info('current_user.about_me: ' + current_user.about_me)
